...
def test_signals_endpoint_returns_importantchanges():
    ...
    pytest.skip("not implemented — stub for FAST-01/SIG-01: signals endpoint not yet built")


def test_hospitalization_flag():
    """When mock agent output has hospitalization=True, response['signals']['hospitalization'] is True."""
    pytest.skip("not implemented — stub for SIG-01: signal field mapping not yet wired")
...
def test_signals_upsert_called():
    ...
    pytest.skip("not implemented — stub for SIG-01: upsert not yet implemented")
