...
_ERROR_CODE_GROUPS = {
    ...
    # GROUNDING_REQUEST_TOO_LARGE and GROUNDING_LATENCY_GATE (round9-revision.md section 4.4(c),
    # 8.4): canonicalizing them here, under the SAME group as MODEL_CALL_BUDGET_EXCEEDED/
    # VALIDATION_BUDGET_EXCEEDED, means every existing `exc.code`-keyed handler needs no update
