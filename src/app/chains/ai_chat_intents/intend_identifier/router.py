...
from src.app.models.intent_identify import IntentAiResponse, IntentResponse, MedicalIntentResponse
...
class IntentRouter:
    ...
    async def route(self, intent: str, **kwargs) -> Union[IntentResponse, MedicalIntentResponse]:
        """
        ...
        Returns:
            Union[IntentResponse, MedicalIntentResponse]: The response from the appropriate handler
        """
    ...
    async def handle_medical_inquiry(self, **kwargs) -> MedicalIntentResponse:
