...
class ClerkAuthMiddleware(BaseHTTPMiddleware):
    ...
    async def _dispatch_authenticated(self, request: Request, call_next):
        """
        ...
        try:
            ...
            if service_key and internal_key and __import__("hmac").compare_digest(service_key, internal_key):
